...
/* Palabras */
palabras_array.push("HOME");
palabras_array.push("CAT");
palabras_array.push("LOVE");
palabras_array.push("MOTHER");
palabras_array.push("FATHER");
...
function pistaFunction(palabra) {
    ...
    switch (palabra) {  // Se crea un switch para poder controlar las pistas segun la palabra 
        case 'LOVE':   // Se debera hacer un case por cada palabra 
            pista = "AMOR";
            break;     // Es importante el break en cada case 
        case 'HOME':
            pista = "Better is nothing";
            break;
        case 'CAT':
            pista = "Best friend";
            break;
        case 'FATHER':
            pista = "You but more adult";
            break;
        case 'MOTHER':
            pista = "Only Woman";
        default:  // El defaul se puede omitir // 
            pista = "Not there track bitches xD";
    }
...
function horca(errores) {
    ...
    imagen.src = "src/img/ahorcado" + errores + ".png";
...
function selecciona(e) {
    ...
    if (i < teclas_array.length) {
        ...
        tecla.x - 1;
        /* verificar  si gano y manda a la funcion gameover */
...
function gameOver(errores) {
    ...
    if (errores < 5) {
        ctx.fillText("Alright the word is: ", 110, 280);
    } else {
